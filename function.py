# Functions (Beta Mixture model) in this module are from:
# https://github.com/PaulAlbert31/LabelNoiseCorrection/blob/master/utils.py
#
# MIT License
# Copyright (c) 2019 Diego Ortego, Eric Arazo, Paul Albert,
# Noel E. O'Connor, Kevin McGuinness
# https://github.com/PaulAlbert31/LabelNoiseCorrection/blob/main/LICENSE
